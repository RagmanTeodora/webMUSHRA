...
//     var currentPosition = this.audioCurrentPosition;
//     var reachedEnd = false;

//     for (var ch = 0; ch < outputBuffer.numberOfChannels; ++ch) {
//         var outputData = outputBuffer.getChannelData(ch);
//         var inputData = audioBuffer.getChannelData(ch % audioBuffer.numberOfChannels);
...
//                 outputData[sample] = inputData[currentPosition++];
//             } else {
//                 // Fill rest with silence and mark end
//                 outputData[sample] = 0;
//                 reachedEnd = true;
//             }
//         }
...
//     // If we hit the end and we're not looping → stop
//     if (reachedEnd && !loopingActive) {
//         this.audioPlaying = false;
//     }
