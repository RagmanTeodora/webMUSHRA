...
MushraPage.prototype.renderCanvas = function(_parentId) {
  ...
  $('#mushra_canvas').offset({top: $('#td_Mushra').offset().top, left : $('#td_Mushra').offset().left});
  ...
  var xLetters = $("#spaceForScale").offset().left - $('#mushra_items').offset().left + $("#spaceForScale").width() / 2.0;
